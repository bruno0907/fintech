...
export function InvestmentIcon({ className }: IconProps) {
  return (
    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M22 26.4332V24.0332" stroke="#495057" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M22.7347 24.0334H21.2645C20.478 24.0334 19.8401 23.3977 19.8401 22.6134V21.6123C19.8401 20.8279 20.478 20.1934 21.2645 20.1934H22.7347C23.5221 20.1934 24.16 20.8279 24.16 21.6123V22.6134C24.16 23.3977 23.5221 24.0334 22.7347 24.0334Z" stroke="#495057" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
